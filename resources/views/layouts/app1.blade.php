...
<!-- 
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      @can("admin")
        ...
        <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text"></i><span>Indexation/Repartition</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
         <li>
            <a href="{{route('admin.Indexations.gestionIndexation')}}">
              <i class="bi bi-circle"></i><span>Indexation</span>
            </a>
          </li>
          <li>
            <a href="{{route('admin.Indexations.communes')}}">
 ...
 <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright 2024 <strong><span>MINDDEVEL (Ministère de la Décentralisation et du Developpement Local)</span></strong>. Tous les droits réservés
    </div>
    <div class="credits"> 
    </div>
  </footer>
